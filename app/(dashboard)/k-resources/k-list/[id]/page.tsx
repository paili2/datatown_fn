...
import TextBox from "@/k-resource/detail/components/TextBox";
...
import BlockHeading from "@/k-resource/detail/components/BlockHeading";
import { tagData } from "@/k-resource/detail/data/kResourceDetailData";
import DetailSection from "@/k-resource/detail/components/DetailSection";
            ...
            <section className="w-2/3 mx-auto flex flex-col justify-between pl-10 gap-10">
                ...
                <div className="flex flex-col justify-between gap-2">
                    ...
                    <div className="flex gap-2">
                        {tagData.map((data, index)=><Badge key={index} color="light">{data}</Badge>)}
                        </div>
                </div>
                <div className="flex flex-col justify-between gap-2">
